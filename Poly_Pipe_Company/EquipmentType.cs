    ...
    public partial class EquipmentType : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "insert into EquipmentType values ('" + textBox2.Text + "')";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select * from EquipmentType", con);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "delete from EquipmentType where [Type ID] = '" + int.Parse(textBox1.Text) + "' ";
            cmd.ExecuteReader();
            con.Close();
